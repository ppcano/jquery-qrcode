...
a.isDark(f,h)?"#000000":"#ffffff";d.fillRect(h*b,f*e,b,e)}a=c}else{a=new p(l.typeNumber,l.correctLevel);a.addData(l.text);a.make();c=u("<table></table>").css("width",l.width+"px").css("height",l.height+"px").css("border","0px").css("border-collapse","collapse").css("background-color","#ffffff");d=l.width/a.getModuleCount();b=l.height/a.getModuleCount();for(e=0;e<a.getModuleCount();e++){f=u("<tr></tr>").css("height",b+"px").appendTo(c);for(h=0;h<a.getModuleCount();h++)u("<td></td>").css("width",d+
"px").css("background-color",a.isDark(e,h)?"#000000":"#ffffff").appendTo(f)}a=c}jQuery(a).appendTo(this)})}})(jQuery);
