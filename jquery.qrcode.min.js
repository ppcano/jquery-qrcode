...
128>>>this.length%8;this.length++}};if(typeof l==="string")l={text:l};l=u.extend({},{render:function(){var a=document.createElement("canvas");return!!(a.getContext&&a.getContext("2d"))}()?"canvas":"table",width:256,height:256,typeNumber:-1,correctLevel:v.H},l);return this.each(function(){var a;if(l.render=="canvas"){a=new p(l.typeNumber,l.correctLevel);a.addData(l.text);a.make();var c=document.createElement("canvas");c.width=l.width;c.height=l.height;for(var d=c.getContext("2d"),b=l.width/a.getModuleCount(),
